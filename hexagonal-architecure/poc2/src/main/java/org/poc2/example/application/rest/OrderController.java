package org.poc2.example.application.rest;

import org.poc2.example.application.request.AddProductRequest;
import org.poc2.example.application.request.CreateOrderRequest;
import org.poc2.example.application.response.CreateOrderResponse;
...
/**
 * This is input adapter that calls input port.
 */
@RestController
